            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between flex-wrap gap-2">
                <div>
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400">
                        <span><?php echo __('المعروض'); ?></span>
                        <span class="font-medium"><?php echo e($paginator->firstItem()); ?></span>
                        <span><?php echo __('الي'); ?></span>
                        <span class="font-medium"><?php echo e($paginator->lastItem()); ?></span>
                        <span><?php echo __('من اصل'); ?></span>
                        <span class="font-medium"><?php echo e($paginator->total()); ?></span>
                        <span><?php echo __('النتيجه'); ?></span>
                    </p>
                </div>

                <div>
                    <span class="relative z-0 inline-flex rtl:flex-row-reverse rounded-md shadow-sm flex-wrap">
                        <span>
                                    ...
                                    <span wire:key="paginator-<?php echo e($paginator->getPageName()); ?>-page<?php echo e($page); ?>">
                                        <?php if($page == $paginator->currentPage()): ?>
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-brown-max border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600"><?php echo e($page); ?></span>
                                            </span>
                                        <?php else: ?>
...
<?php /**PATH /home/thomas/Projects/LibaryLaravel/resources/views/vendor/livewire/tailwind.blade.php ENDPATH**/ ?>