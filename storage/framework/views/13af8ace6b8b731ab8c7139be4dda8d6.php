...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['type' => 'submit','wire:loading.attr' => 'disabled','class' => 'justify-center py-4 mt-4 text-center text-sm w-full bg-brown-max hover:bg-brown-lite duration-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','wire:loading.attr' => 'disabled','class' => 'justify-center py-4 mt-4 text-center text-sm w-full bg-brown-max hover:bg-brown-lite duration-200']); ?>
...
<?php endif; ?>
        ...
        <p class="text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" wire:navigate class="text-brown-max">
                إنشاء حساب
            </a>
        </p>
    </form>
</div><?php /**PATH /home/thomas/Projects/LibaryLaravel/resources/views/livewire/pages/auth/login.blade.php ENDPATH**/ ?>