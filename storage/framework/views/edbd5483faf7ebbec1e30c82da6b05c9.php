    ...
    <div class="container max-w-full px-6 mt-4">
        ...
        <div class="mt-10 grid gap-4" style="grid-template-columns: repeat(auto-fill, minmax(250px, 1fr))">
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button wire:key="<?php echo e($section->id); ?>" type="button" x-data="{ isOpen: false }"
                    ...
                    <div class="flex justify-between gap-2 items-center">
                        <span class="text-lg flex gap-2 items-center">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(App\Enums\PermissionEnum::SECTIONS_BOOK->value)): ?>
                                <!-- Edit Section Button -->
                                <span wire:click.stop='editSection(<?php echo e($section->id); ?>)'
                                    class="me-2 hover:text-amber-600 duration-150 cursor-pointer" aria-label="Edit Section">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </span>
                            <?php endif; ?>
                            <!-- Section Title Link -->
                            <a href="<?php echo e(route('search', ['search' => $section->title])); ?>" wire:navigate
                    ...
                    <div class="flex flex-col gap-4 mt-4" x-show="isOpen" x-cloak>
                        <?php $__empty_1 = true; $__currentLoopData = $section->shelfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shelf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="p-2 rounded-lg flex justify-between gap-2 items-center bg-gray-100 hover:bg-slate-200 duration-200">
                                <span class="text-lg flex gap-2 items-center">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(App\Enums\PermissionEnum::SECTIONS_BOOK->value)): ?>
                                        <!-- Edit Shelf Button -->
                                        <span wire:click.stop='editShelf(<?php echo e($shelf->id); ?>)'
                                    ...
                                    <?php endif; ?>
                                    <!-- Shelf Title Link -->
                                    <a href="<?php echo e(route('search', ['search' => $shelf->title])); ?>" wire:navigate
                                        class="hover:text-brown-max duration-150">
                                        <i class="fa-solid fa-book-bookmark text-xl"></i>
                                        <span><?php echo e($shelf->title); ?></span>
                                    </a>
                                </span>
                                <!-- Shelf Number -->
                                <span class="bg-brown-max text-white text-xm py-1 px-2 rounded-xl">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['type' => 'submit','wire:loading.attr' => 'disabled','class' => 'ms-3 bg-brown-lite hover:bg-brown-max active:bg-brown-max focus:ring-brown-max']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','wire:loading.attr' => 'disabled','class' => 'ms-3 bg-brown-lite hover:bg-brown-max active:bg-brown-max focus:ring-brown-max']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loader','data' => ['wire:loading' => true,'wire:target' => 'updateSection']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:loading' => true,'wire:target' => 'updateSection']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'submit','wire:loading.attr' => 'disabled','class' => 'ms-3 bg-brown-lite hover:bg-brown-max active:bg-brown-max focus:ring-brown-max']); ?>
                                <?php if (isset($component)) { $__componentOriginald5d051f243b37508d39f8ce3d92a5684 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald5d051f243b37508d39f8ce3d92a5684 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loader','data' => ['wire:loading' => true,'wire:target' => 'updateShelf']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('loader'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:loading' => true,'wire:target' => 'updateShelf']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald5d051f243b37508d39f8ce3d92a5684)): ?>
<?php $attributes = $__attributesOriginald5d051f243b37508d39f8ce3d92a5684; ?>
...
<?php unset($__componentOriginal9f64f32e90b9102968f2bc548315018c); ?>
<?php endif; ?>
</div><?php /**PATH /home/thomas/Projects/LibaryLaravel/resources/views/livewire/sections-page.blade.php ENDPATH**/ ?>