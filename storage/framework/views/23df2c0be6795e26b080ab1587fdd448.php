...
<div class="w-full" :key="$id" x-data="dropdown({
    ...
    selectedId: <?php if ((object) ($property) instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($property->value()); ?>')<?php echo e($property->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($property); ?>')<?php endif; ?>,
    nameProperty: '<?php echo e($nameProperty); ?>',
    placeholder: '<?php echo e($placeholder); ?>',
    nameEvent: '<?php echo e($nameEvent); ?>',
    property: '<?php echo e($property); ?>'
})" @click.away="open = false; search = ''">
    <div class="relative">
        <!-- Dropdown Button -->
        <button @click="open = !open" type="button" :class="['<?php echo e($buttonClass); ?>']" aria-haspopup="listbox"
            :aria-expanded="open">
        ...
        <div x-show="open" x-cloak x-transition.opacity
            ...
            <!-- Search Input -->
            <input type="text" x-model="search" placeholder="<?php echo e($searchPlaceholder); ?>" id="<?php echo e($id); ?>"
...
<?php /**PATH /home/thomas/Projects/LibaryLaravel/resources/views/components/searchable-select.blade.php ENDPATH**/ ?>