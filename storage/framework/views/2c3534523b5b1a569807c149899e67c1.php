...
<label <?php echo e($attributes->merge(['class' => 'block  text-sm text-gray-500'])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH /home/thomas/Projects/LibaryLaravel/resources/views/components/input-label.blade.php ENDPATH**/ ?>